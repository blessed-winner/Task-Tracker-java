<%@ page import="java.util.List, com.task.tracker.model.Category, com.task.tracker.model.Task" %>
<html>
<head>
...
<div class="form-box">
    <h2><%= (t == null) ? "Register Task" : "Amend Task" %></h2>
    <form action="tasks" method="post">
        <% if(t != null) { %><input type="hidden" name="id" value="<%= t.getId() %>"><% } %>
        <div class="field">
            <label>Nominal Title</label>
            <input type="text" name="title" value="<%= (t != null) ? t.getTitle() : "" %>" required>
        </div>
        <div class="field">
            <label>Technical Description</label>
            <textarea name="description" rows="3"><%= (t != null) ? t.getDescription() : "" %></textarea>
        </div>
        <button type="submit">Execute Entry</button>
    </form>
    <a href="tasks" class="back">CANCEL</a>
</div>
</body>
</html>